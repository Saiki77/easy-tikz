...
- [`forum.md`](forum.md) — long-form post for [forum.obsidian.md](https://forum.obsidian.md) → Share & showcase.
...
3. **Obsidian forum.** Post `forum.md` to Share & showcase. Pin a reply that says "feedback / bugs welcome here or on the GitHub issue tracker."
4. **Reddit.** Post `reddit.md` to r/ObsidianMD with the Plugin / Showcase flair. Reply to comments for a couple of hours after posting.
5. **Social.** Send the three variants in `social.md` to X / Mastodon / Bluesky in whatever order suits your audience. Each pairs naturally with `docs/screenshots/demo-overview.gif`.
