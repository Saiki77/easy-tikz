...
var TikzModal = class extends import_obsidian.Modal {
  ...
  buildFunctionsTab(container) {
    ...
    const addFunctionCard = () => {
      ...
      new import_obsidian.Setting(deleteBtn).addButton((btn) => btn.setIcon("trash").setTooltip("Remove function").onClick(() => {
